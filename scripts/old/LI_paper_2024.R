...
# pre_filt_tbl$Sample %>% unique() %>% sort() %>% paste0(collapse = '",\n"') %>% cat()
{
  ...
  # Site
  Site <- c("SP01", "SP02", "SP02", "SP03", "SP04", "SP02", "SP01", "SP03", "SP04", "SP02", "SP01",
  "SP03", "SP04", "SP02", "SP01", "SP03", "SP04", "SP02", "SP01")
...
{wider_dt_all_resume <- dt_all_resume %>% 
  ...
  relocate("Class","Curated ID","Final ID (BLASTn)","Total reads", "Total abundance",
           #2020 MCE
           "SP01_Full_2020_MCE_Reads",
           "SP01_Full_2020_MCE_ASVs",
           "SP01_Full_2020_MCE_OTUs",
           "SP01_Full_2020_MCE_RRA",
           "SP02_Full_2020_MCE_Reads",
           "SP02_Full_2020_MCE_ASVs",
           "SP02_Full_2020_MCE_OTUs",
           "SP02_Full_2020_MCE_RRA",
           #2021 MCE
           "SP01_Low_2021_MCE_Reads",
           "SP01_Low_2021_MCE_ASVs",
           "SP01_Low_2021_MCE_OTUs",
           "SP01_Low_2021_MCE_RRA",
           "SP02_Low_2021_MCE_Reads",
           "SP02_Low_2021_MCE_ASVs",
           "SP02_Low_2021_MCE_OTUs",
           "SP02_Low_2021_MCE_RRA",
           "SP03_Low_2021_MCE_Reads",
           "SP03_Low_2021_MCE_ASVs",
           "SP03_Low_2021_MCE_OTUs",
           "SP03_Low_2021_MCE_RRA",
           "SP04_Low_2021_MCE_Reads",
           "SP04_Low_2021_MCE_ASVs",
           "SP04_Low_2021_MCE_OTUs",
           "SP04_Low_2021_MCE_RRA",
           #2022 MCE
           "SP01_Full_2022_MCE_Reads",
           "SP01_Full_2022_MCE_ASVs",
           "SP01_Full_2022_MCE_OTUs",
           "SP01_Full_2022_MCE_RRA",
           "SP02_Full_2022_MCE_Reads",
           "SP02_Full_2022_MCE_ASVs",
           "SP02_Full_2022_MCE_OTUs",
           "SP02_Full_2022_MCE_RRA",
           "SP03_Full_2022_MCE_Reads",
           "SP03_Full_2022_MCE_ASVs",
           "SP03_Full_2022_MCE_OTUs",
           "SP03_Full_2022_MCE_RRA",
           "SP04_Full_2022_MCE_Reads",
           "SP04_Full_2022_MCE_ASVs",
           "SP04_Full_2022_MCE_OTUs",
           "SP04_Full_2022_MCE_RRA"
  )}
...
filt_tbl <- curated_full_tbl %>% 
  ...
  filter(!`Curated ID` %in% c("Salmo salar")) %>% 
...
# Tabela wider com os dados filtrados
{
  ...
  relocate("Curated ID",
           "Total abundance",
           #2020 MCE
           "SP01_Full_2020_Reads",
           "SP01_Full_2020_ASVs",
           "SP01_Full_2020_OTUs",
           "SP01_Full_2020_RRA",
           "SP02_Full_2020_Reads",
           "SP02_Full_2020_ASVs",
           "SP02_Full_2020_OTUs",
           "SP02_Full_2020_RRA",
           #2021 MCE
           ...
           "SP04_Low_2021_RRA",
           #2021 Sterivex
           # "SP03_Low_2021_Sterivex_Reads",
           # "SP03_Low_2021_Sterivex_ASVs",
           # "SP03_Low_2021_Sterivex_OTUs",
           # "SP03_Low_2021_Sterivex_RRA",
           # "SP04_Low_2021_Sterivex_Reads",
           # "SP04_Low_2021_Sterivex_ASVs",
           # "SP04_Low_2021_Sterivex_OTUs",
           # "SP04_Low_2021_Sterivex_RRA",
           # "SP01_Low_2021_Sterivex_Reads",
           # "SP01_Low_2021_Sterivex_ASVs",
           # "SP01_Low_2021_Sterivex_OTUs",
           # "SP01_Low_2021_Sterivex_RRA",
           # "SP02_Low_2021_Sterivex_Reads",
           # "SP02_Low_2021_Sterivex_ASVs",
           # "SP02_Low_2021_Sterivex_OTUs",
           # "SP02_Low_2021_Sterivex_RRA",
           #2022 MCE
           "SP03_Full_2022_Reads",
           "SP03_Full_2022_ASVs",
           "SP03_Full_2022_OTUs",
           "SP03_Full_2022_RRA",
           "SP04_Full_2022_Reads",
           "SP04_Full_2022_ASVs",
           "SP04_Full_2022_OTUs",
           "SP04_Full_2022_RRA"
           # "SP01_Full_2022_Reads", # Os dois prox pontos nao sobreviveram 
           # "SP01_Full_2022_ASVs", # aos filtros por que nao tem ASVs de peixes 
           # "SP01_Full_2022_OTUs",
           # "SP01_Full_2022_RRA",
           # "SP02_Full_2022_Reads",
           # "SP02_Full_2022_ASVs",
           # "SP02_Full_2022_OTUs",
           # "SP02_Full_2022_RRA"
  )
...
seq_read_counts <- read_excel("/home/gabriel/projetos/peixes-eDNA/analises/dez_23/runs_2_4_5_EM156/results/LI-reads_and_seqs_counts2024-01-08.xlsx") %>% 
  tibble() %>%
  # Se necessario escolher amostras pareadas, filtrar: 
   filter(Sample %in% c(
...
# filt_raw_sampled_reads <- grouped_sampled_filt_tbl %>% 
filt_raw_reads <- grouped_filt_tbl %>%
  # Se necessario escolher apenas as amostras pareadas, filtrar: 
  # filter(Expedition %in% "Novembro 2021") %>%
  # )) %>% 
  # group_by(Sample) %>% # grouped_sampled_filt_tbl
...
# grouped_sampled_stats <- grouped_sampled_filt_tbl %>%
...
## Grouped by Filter
grouped_filter <- grouped_sampled_filt_tbl %>%
  ungroup() %>% 
  filter(Expedition %in% "Novembro 2021") %>%
  ...
  reframe("Total filter reads" = sum(Reads),
          ...
          "Total Genera" = n_distinct(Genus),
          "Total Species" = n_distinct(`Curated ID`[grepl("^[A-Za-z]+\\s[A-Za-z]+$", `Curated ID`) & !grepl("sp\\.", `Curated ID`)]),
          "Total Nspecies" = n_distinct(`Curated ID`) - `Total Species`
          ) %>%
  unique() 
...
# id_level <- grouped_sampled_filt_tbl %>%
...
# order_level <- grouped_sampled_filt_tbl %>%
# order_level_2 <- grouped_filt_tbl %>%
order_level_3 <- grouped_filt_tbl %>%
  filter(Filter %in% "MCE") %>%
  group_by(Order) %>%
  reframe(
    "Curated ID" = `Curated ID`,
...
write.xlsx(order_level_2, paste0(tbl_path, "/order_level_tbl_2.xlsx"))
...
# Tile MCE samples
    tile_mce_samples <- grouped_sampled_filt_tbl %>%
      filter(Filter %in% "MCE") %>% 
      mutate(`Curated ID` = factor(`Curated ID`, levels = rev(spp_levels))) %>% 
      mutate(Site = factor(Site)) %>%
      mutate(Order = factor(Order)) %>%
...
## Permanova ----
  ...
  Dispersion <- betadisper(pcOa_dist, group = mce_stx_IDs_NMDS_df$Filter, type = "centroid") # testando a dispercao
  ...
  perma_test <- adonis2(pcOa_mtx ~ as.factor(mce_stx_IDs_NMDS_df$Filter), data = pcOa_mtx,
                   permutations=9999)
  perma_test
...
# All samples (Richness vs Samples)
{
  ...
  accum_mce_stx_df <- tibble("Sites" = c(0, accum_stx_mce$sites),
                             ...
                             "Filter" = "Combined MCE and Sterivex (November 2021)")
  ...
  combined_accum$Filter <- factor(combined_accum$Filter,
                                  levels = c("All samples",
                                             "MCE",
                                             "Combined MCE and Sterivex (November 2021)",
                                             "MCE (November 2021)",
                                             "Sterivex"))
